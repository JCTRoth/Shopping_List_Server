...
TIP: Detailed documentation is available in the link:docs/index.adoc[docs/] folder, including the link:docs/api-json-exchange.adoc[API JSON Exchange Reference] and link:docs/database-integration.adoc[Database Integration] guide.
