...
- install mysql on your server and create a schema "shoppinglistserver" with a user "ShoppingListDBUser" and password "REPLACE_WITH_DB_PASSWORD". This is specified in appsettings.json.
